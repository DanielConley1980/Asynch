...
const quizData = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "The most common way the ABC breaks down in practice is:", opts: ["A) Spending too long on Acknowledge and never quite reaching the boundary or the coaching", "B) Setting boundaries that are far too firm for what the situation actually calls for", "C) Attempting the Coaching step before the student is anywhere near ready to hear it", "D) Skipping Acknowledge and jumping straight to the correction — the student feels unheard and escalates"], answer: "D", callback: false },
      { q: "(Reference: Sessions 8, 9) In the Acknowledge step, what are you actually doing in empathy/sympathy terms?", opts: ["A) Offering sympathy — reassuring the student that things aren't as bad as they seem", "B) Offering empathy — sitting with the feeling and showing it makes sense, before any correcting", "C) Staying carefully neutral so that the behaviour can be dealt with objectively", "D) Modelling the classroom's rules about how feelings should be expressed"], answer: "B", callback: [8, 9] }
    ]
  },
  {
