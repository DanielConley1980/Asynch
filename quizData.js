...
const quizData = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "'Listen empathetically and validate the child's feelings' means:", opts: ["A) Agreeing that the child's behaviour was acceptable", "B) Communicating that the feeling itself makes sense, even if the behaviour needs to change", "C) Waiting silently until the child stops talking", "D) Explaining why the child shouldn't feel that way"], answer: "B", callback: false },
      { q: "Setting limits on the behaviour is introduced:", opts: ["A) Before the emotion has been named or validated, so the boundary is clear from the outset", "B) After noticing, connecting, listening and helping label the emotion — the limit sits alongside problem-solving, not instead of it", "C) Only when the behaviour becomes dangerous", "D) By a different adult from the one doing the emotional coaching"], answer: "B", callback: false },
      { q: "(Reference: Session 8) How does \"listen empathetically and validate\" connect to the empathy/sympathy distinction from that session?", opts: ["A) They're unrelated — session 8 is about adult relationships, this is about children", "B) Both distinguish sitting with a feeling (empathy) from minimising or fixing it too fast (sympathy) — validating without rushing to solve is empathy in action", "C) Sympathy is the preferred approach in Emotion Coaching, not empathy", "D) Emotion Coaching replaces empathy with a structured checklist"], answer: "B", callback: 8 }
    ]
  },
  {
    session: 10, title: "Emotion Coaching 2",
    questions: [
      { q: "Where is the evidence of the ABC in the video? Which matching is correct?", opts: ["A) Attunement phrases like \"I can see that…\" and \"I'm wondering…\" show Acknowledge; holding the limit while keeping the feeling acceptable shows Boundaries; exploring what to do differently next time shows Coaching", "B) \"I can see that…\" shows Boundaries; setting the limit shows Coaching; problem-solving shows Acknowledge", "C) The video only demonstrates Acknowledge — Boundaries and Coaching are not modelled", "D) The phrases are general behaviour management and don't map onto the ABC at all"], answer: "A", callback: false },
      { q: "Emily is over twenty minutes late for her lesson after break. She is wandering the corridors, banging on classroom windows every so often and refusing to be redirected to her classroom or her head of year's office. What does an ABC approach open with?", opts: ["A) A clear instruction: back to class now, or it becomes a head of year matter", "B) Walking alongside her, unhurried, and acknowledging first — \"I can see something's making it hard to be in class right now\" — before any redirection", "C) Radioing for senior staff so she can be removed from the corridor quickly", "D) Following her silently at a distance until she runs out of steam"], answer: "B", callback: false },
      { q: "You hear a locker being kicked and damaged. Jake storms past, hands deep in his pockets, visibly frustrated; other students are whispering. He kicks a stray book down the hall, then stops and leans against the lockers, arms crossed, staring at the ground. Using the ABC, your opening move is:", opts: ["A) Point out the damage to the locker and explain what it will cost him", "B) Ask him directly why he kicked the locker in front of the other students", "C) Approach calmly and acknowledge what you can see — \"Something's really wound you up\" — using his pause as the window to connect; the boundary about the damage comes once he's settled", "D) Send him straight to isolation so the audience disperses"], answer: "C", callback: false },
      { q: "Adam entered your class late — storming in, slamming the door, sitting in the wrong seat and putting his head on the desk. You've resettled the class and are ready to address it. The ABC-consistent move is:", opts: ["A) Insist he moves to his correct seat before anything else — the boundary must come first", "B) Address the lateness and door-slamming publicly so the class sees it dealt with", "C) Leave him completely alone — he'll come round on his own", "D) Crouch beside him and acknowledge quietly — \"I can see something's happened; I'm glad you're here\" — leaving the seat and the lateness until he's settled enough to hear it"], answer: "D", callback: false },
      { q: "You're waiting for a parent in reception when Chloe storms in, phone clamped to her ear, face red, shouting \"I don't care, Mum! I'm not doing it! Nobody ever listens to me!\" The receptionist looks exasperated and visitors are watching. What does the ABC look like here?", opts: ["A) Acknowledge and boundary in one calm move — \"I can hear how angry you are; come with me and let's sort it away from here\" — taking her somewhere quieter before any coaching", "B) Tell her to hang up the phone immediately — reception is not the place for this", "C) Stay out of it — you're waiting for a parent, and it's the receptionist's area", "D) Point out that she's embarrassing herself in front of visitors so she understands the impact"], answer: "A", callback: false }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      { q: "The cortex is the last brain region to mature and the first to be affected by stress. This is sometimes described as:", opts: ["A) The cortical vulnerability paradox", "B) Last online, first offline — explaining why reasoning is both the highest aspiration and the most fragile capacity", "C) The executive function ceiling", "D) The developmental lag hypothesis"], answer: "B", callback: false },
      { q: "A student who 'knows the rules but can't follow them' in moments of distress is most likely experiencing:", opts: ["A) Deliberate defiance", "B) Cortical access failure — they know what they should do but cannot access that knowledge when the lookout system is activated", "C) A learning difficulty affecting rule retention", "D) Inconsistent boundary-setting at home"], answer: "B", callback: false },
      { q: "Which condition is necessary for the cortex to function effectively?", opts: ["A) High motivation and clear goals", "B) Regulation and sufficient felt safety — the lower brain must be settled before the upper brain is accessible", "C) Intelligence and prior knowledge", "D) A structured and quiet learning environment"], answer: "B", callback: false },
      { q: "The Reason tier of the RRR triangle can only be built on:", opts: ["A) Academic readiness alone", "B) Stable regulation AND established relationship — both lower tiers must be in place", "C) Motivation and aspiration", "D) Parental support and engagement"], answer: "B", callback: false },
      { q: "(Reference: Sessions 2, 4) A teacher asks a student to write a reflective account immediately after a difficult incident. What is the most likely outcome?", opts: ["A) The student will reflect honestly because they remember the incident clearly", "B) The student cannot produce meaningful reflection until their cortex is back online — the task should wait until they are within their window", "C) Written reflection is always more effective immediately after an event", "D) The outcome depends entirely on the student's emotional intelligence"], answer: "B", callback: [2, 4] }
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      { q: "What is Kintsugi, literally?", opts: ["A) A Japanese meditation technique focused on stillness", "B) The Japanese art of repairing broken pottery with gold or lacquer, making the repair visible rather than hidden", "C) A style of pottery glazing developed in the 20th century", "D) A form of calligraphy focused on incomplete brushstrokes"], answer: "B", callback: false },
      { q: "The Kintsugi philosophy holds that an object repaired this way is:", opts: ["A) Less valuable because it has been damaged", "B) More beautiful and valuable because of — not despite — its breaks and repair", "C) Restored to look exactly as if it had never broken", "D) Only valuable as a historical curiosity"], answer: "B", callback: false },
      { q: "Applied to people, Kintsugi's central idea is that:", opts: ["A) Difficult experiences should be hidden so others don't see the damage", "B) Scars and hard years are the visible gold — they add to a person's story rather than diminishing it", "C) People who haven't experienced hardship are inherently more resilient", "D) Damage should be repaired as quickly and invisibly as possible"], answer: "B", callback: false },
      ...
      { q: "(Reference: Session 5) How does Kintsugi build on what session 5 explored about early trauma?", opts: ["A) They're unrelated — trauma is clinical, Kintsugi is philosophical/artistic", "B) Both reject the idea that difficult experience is simply damage to erase — trauma shapes without defining, and the break can become the site of visible, valued repair", "C) Kintsugi replaces trauma-informed practice with a more upbeat framing", "D) Trauma should be forgotten quickly so the repair can begin"], answer: "B", callback: 5 }
    ]
  }
];
